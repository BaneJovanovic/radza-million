...
class RadzaMilion
{
    ...
    public function analyzeButtonClickResult($postedData)
    {
        $creamStrategyData = array(
            ...
            'cream_taker'            => isset($postedData['cream-taker']) ? $postedData['cream-taker'] : '',
            'percentage_for_cream'   => isset($postedData['percentage-for-cream']) ? $postedData['percentage-for-cream'] : '',
            'showstopper'            => isset($postedData['showstopper']) ? $postedData['showstopper'] : '',
            'change_criteria'        => isset($postedData['change-criteria']) ? $postedData['change-criteria'] : ''
        );
        ...
        $analyzeButtonClickResult = $this->getBettingResults(
            ...
            $postedData['budget'],
            $postedData['percentage-used'],
            $postedData['turning-saldo-velocity'],
            $creamStrategyData
        );
